dungeonGenerator: dungeonObjects.o dungeonRoomGenerator.o dungeonLevelGenerator.o dungeonIO.o binheap.o Dijkstra.o Graph.o CharacterController.o GameStateManager.o dice.o MonsterParser.o dungeonGenerator.o
	g++ dungeonObjects.o dungeonRoomGenerator.o dungeonLevelGenerator.o dungeonIO.o binheap.o Dijkstra.o Graph.o CharacterController.o  GameStateManager.o dice.o MonsterParser.o dungeonGenerator.o -o dungeonGenerator -lm -lcurses
...
MonsterParser.o: MonsterParser.h MonsterParser.cpp
	g++ -g -Wall -Werror MonsterParser.cpp -c
